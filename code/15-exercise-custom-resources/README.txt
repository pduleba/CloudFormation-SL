...
# AWS SNS Custom Resource
https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-custom-resources-sns.html
# AWS Lambda Custom Resource
...
# S3 bucket (pduleba-cloud-formation-sl-s3-bucket)
CloudFormation-SL/code/2-exercise-create-s3-bucket/create-s3-bucket-custom-name.yaml
